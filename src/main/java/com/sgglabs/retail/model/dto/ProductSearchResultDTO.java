...
public class ProductSearchResultDTO {
    ...
    private List<SellerProductDataDTO> sellerDataList;
    ...
    public List<SellerProductDataDTO> getSellerDataList() {
        return sellerDataList;
    }

    public void setSellerDataList(List<SellerProductDataDTO> sellerDataList) {
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id &&
                Objects.equals(sellerDataList, that.sellerDataList) &&
    ...
    public int hashCode() {
        return Objects.hash(id, siteName, searchText, shortDescription, longDescription, price, unit, numberOfReviews,
                totalRatings, otherOptions, categories, status, createdDate, modifiedDate, sellerDataList);
    }
